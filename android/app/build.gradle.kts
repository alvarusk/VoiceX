...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.kingdomm.voicex"
    ...
    buildTypes {
        release {
            // Si hay key.properties se usa firma release; si no, seguimos con debug para no romper builds locales.
